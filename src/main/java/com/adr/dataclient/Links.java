...
public class Links {
    ...
    public Links() {
        FXMLUtil.load(this, "/com/adr/dataclient/fxml/links.fxml", "com/adr/dataclient/fxml/links");
    }
    ...
    private void loadProperties() {
        File f = new File(System.getProperty("user.home"), ".dataclient-links.properties");
