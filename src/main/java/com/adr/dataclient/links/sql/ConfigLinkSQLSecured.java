 ...
 * @author adrian
 */
class ConfigLinkSQLSecured extends ConfigLink {
    
    private final ConfigLinkTypeSQLSecured type;
    
    private DataSQL datasql;

    public ConfigLinkSQLSecured(ConfigLinkTypeSQLSecured type, String name) {
        super(name);
        this.type = type;
    ...
    public AppLink createAppLink() {
        return new AppLinkSQLSecured(getName(), datasql);
    }
}
