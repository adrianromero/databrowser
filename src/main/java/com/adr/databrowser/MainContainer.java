...
public class MainContainer {
    ...
    public MainContainer() {
        ...
        FXMLUtil.load(this, "/com/adr/databrowser/fxml/maincontainer.fxml");   
    }
    ...
    public void initialize() {
        ...
        root.getStylesheets().add(getClass().getResource("/com/adr/databrowser/styles/main.css").toExternalForm());
//        root.getStylesheets().add(getClass().getResource("/com/adr/databrowser/styles/dark.css").toExternalForm());
